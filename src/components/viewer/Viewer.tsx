...
const Viewer = () => {
  ...
  const [model, setModel] = useState<ModelType>({ id: "", collectionName: "", createdAt: new Date(), updatedAt: new Date(), meta: [], documentCount: 0, center: { x: 0, y: 0, z: 0 }, description: "", requiresPassword: false, unlocked: true });
