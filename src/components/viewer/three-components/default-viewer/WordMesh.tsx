                ...
                return (
                    <Billboard key={index} position={[word.vector3.x, word.vector3.y + 0.1, word.vector3.z]}>
                        <Html style={{pointerEvents: "none", zIndex: 49}}>
                            <p style={{color: "black", WebkitTextStrokeWidth: "0.5px", WebkitTextStrokeColor: "#FFFFFF", 
                                userSelect: "none", whiteSpace: "nowrap", fontSize:"1.2em", textAlign: "center", fontWeight: "bold"}}>
                                {word.label}
                            </p>
                        </Html>
                    </Billboard>
